function cleanUpSome(sstring){
	// console.log(sstring, "-->", sstring.replace(String.fromCharCode(92,92), String.fromCharCode(92)));
	return sstring.replace(String.fromCharCode(92,92), String.fromCharCode(92));
	//return sstring.substr(5).slice(0, - 1); // <- legacy scala code
}
